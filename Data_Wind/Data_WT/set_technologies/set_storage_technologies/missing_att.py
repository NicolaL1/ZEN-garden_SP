...
STORAGE_TECH_DIR = r"C:\Users\nicol\GitHub\ZEN-garden_Wind\Data_Wind\Data_WT\set_technologies\set_storage_technologies"

# 📌 Default values for missing attributes (matching the nested format)
DEFAULT_VALUES = {
    "flow_storage_inflow": {"default_value": 1.0, "unit": "GWh/h"},
    "flow_storage_outflow": {"default_value": 1.0, "unit": "GWh/h"},
    "storage_capacity": {"default_value": 100.0, "unit": "GWh"},
    "charge_efficiency": {"default_value": 0.9, "unit": "-"},
    "discharge_efficiency": {"default_value": 0.9, "unit": "-"},
    "energy_to_power_ratio_max": {"default_value": 1.0, "unit": "GWh/kW"}
}
