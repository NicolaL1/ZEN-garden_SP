...
res_basic = Results(r".\outputs\01_SP_MV_PV")
x = res_basic.get_full_ts("flow_conversion_input")
y = res_basic.get_full_ts("flow_conversion_output")
z = res_basic.get_full_ts("carbon_emissions_annual")
a = res_basic.get_full_ts("cost_total")
b = res_basic.get_full_ts("capacity")
c = res_basic.get_full_ts("flow_transport")
d = res_basic.get_full_ts("demand")
e = res_basic.get_full_ts("storage_level")
f = res_basic.get_full_ts("capex_yearly")
g = res_basic.get_full_ts("opex_yearly")
h = res_basic.get_full_ts("cost_capex_total")
i = res_basic.get_full_ts("cost_opex_total")
t = res_basic.get_full_ts("carbon_emissions_technology")
x.to_csv(r".\CSVOutput\flow_conversion_input.csv")
y.to_csv(r".\CSVOutput\flow_conversion_output.csv")
z.to_csv(r".\CSVOutput\carbon_emissions_annual.csv")
a.to_csv(r".\CSVOutput\cost_total.csv")
b.to_csv(r".\CSVOutput\capacity.csv")
c.to_csv(r".\CSVOutput\flow_transport.csv")
d.to_csv(r".\CSVOutput\demand.csv")
e.to_csv(r".\CSVOutput\storage_level.csv")
f.to_csv(r".\CSVOutput\capex_yearly.csv")
g.to_csv(r".\CSVOutput\opex_yearly.csv")
h.to_csv(r".\CSVOutput\cost_capex_total.csv")
i.to_csv(r".\CSVOutput\cost_opex_total.csv")
t.to_csv(r".\CSVOutput\test.csv")
