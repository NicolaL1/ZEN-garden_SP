...
STORAGE_TECH_DIR = r"C:\Users\nicol\GitHub\PV ZEN_garden\Data\01_SP_MV_PV\set_carriers"

# 📌 Default values for missing attributes (matching the nested format)
DEFAULT_VALUES = {
    "carbon_intensity_carrier_import": {"default_value": 0.2, "unit": "kilotons/GWh"},
    "carbon_intensity_carrier_export": {"default_value": 0.2, "unit": "kilotons/GWh"}
